...
minBulListeden= min(numbers) #main metodu default gelen pyhton class'ları sayesinde min() metdounu kullanımımıza sunar
...
#silme işlemini listedeki elemanı direk vererek silme remove() value göre siler
